...
//        boolean asciiTrans = false; //??? never modified, could delete related code
...
//        }
  ...
  public void writeEntry(TarEntry entry, boolean recurse) throws IOException {
    ...
    //
    if(eFile == null) {
      entry = new TarEntry(entry.getName() /*, entry.defaultFileMode, entry.defaultDirMode*/);
    } else {
      //
      ...
      entry = new TarEntry(eFile, entry.defaultFileMode, entry.defaultDirMode);
    ...
    if(this.rootPath != null) {
      ...
      if(oldname.startsWith(this.rootPath)) {
        newName = StringX.subString(oldname, this.rootPath.length() + 1);
      }
    }
...
//paymate.net tweaking
//$Log: TarArchive.java,v $
//Revision 1.3  2004/03/02 00:40:40  andyh
//javaruf client with screaming debug
//
//$Id: TarArchive.java,v 1.3 2004/03/02 00:40:40 andyh Exp $
