 ...
 *
 * $Id: DummyAppletContext.java,v 1.9 2003/07/27 05:34:47 mattm Exp $
 *
 * $Source: /cvs/src/net/paymate/DummyAppletContext.java,v $
 */
...
//                               String args[] ) {
//        super ( ReflectX.shortClassName(applet) );
...
//
//        // Code taken from Java Examples in a Nutshell, 2nd Ed., O'Reilly, Page 185, Example 10-1.
//        addWindowListener(
//          new WindowAdapter() {
...
//                ( height + status.getPreferredSize().height +
