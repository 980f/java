 ...
 * Company:      paymate<p>
 * @author       paymate
 * @version      $Id: FindFiles.java,v 1.2 2004/01/09 11:46:05 mattm Exp $
 */
package net.paymate.io;
import  java.io.File;
import  java.io.FileFilter;
import net.paymate.io.IOX;
import net.paymate.io.DirFilter;
  ...
  public static final TextList ExcludeFilesFrom(TextList fileList, String stale[]){
    ...
    for(int i = fileList.size(); i-->0;) {
      ...
      for(int ex=stale.length; ex-->0;){
        ...
        if(filename.indexOf(exclude)>-1){//this screwed up makeall's "stale" list.
          passed = false;
          break;
        }
      }
