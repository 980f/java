...
/**
 * <p>Title: $Source: /cvs/src/net/paymate/servlet/JavaMailServlet.java,v $</p>
 * <p>Description: </p>
...
public class JavaMailServlet
    extends SessionedServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse res) throws
    ...
    doIt(req, res, false); // cause I'm really lazy
  }

  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws
      ServletException, IOException {
    doIt(req, res, true); // cause I'm really lazy
  }
  ...
  protected void doIt(HttpServletRequest req, HttpServletResponse res,
     ...
     */
    HttpSession ses = req.getSession(post); // before we write to out
    ...
    if (post) {
      ...
      if (send != null) {
        ...
        ses.putValue("javamailservlet", mud);
  ...
  private void displayMessage(MailUserData mud, HttpServletRequest req,
                              ServletOutputStream out, int msgNum) throws
      IOException {
  ...
  private void displayMessageHeaders(MailUserData mud, Message msg,
                                     ServletOutputStream out) throws
      IOException {
  ...
  private void send(HttpServletRequest req, HttpServletResponse res,
                    ServletOutputStream out, MailUserData mud) throws
      IOException {
