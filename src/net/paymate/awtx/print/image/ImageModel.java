/**
 * Title:        $Source: /cvs/src/net/paymate/awtx/print/image/ImageModel.java,v $
 * Description:  Printing to image formatter <p>
 * Copyright:    2000<p>
 * Company:      PayMate.net<p>
 * @author       PayMate.net
 * @version      $Id: ImageModel.java,v 1.1 2003/12/09 00:10:33 mattm Exp $
 *
...
abstract public class ImageModel extends PrinterModel {
  ...
  public static final String DEFAULTFONTNAME = "Lucida Console";
  ...
  private void doOnce(PrinterModel lp, boolean signature, String fontName) {//only called by constructor
    textWidth=lp.textWidth(); // this is the only thing we copy from lp, besides the Aspect
 ...
 */
  ...
  public ImageModel(PrinterModel lp, OutputStream os, int linesOfText, boolean signature, String fontName) {
    super();
    this.os = os;
    dbg.ERROR("Setting font to " + fontName);
    doOnce(lp, signature, fontName);
...
//$Id: ImageModel.java,v 1.1 2003/12/09 00:10:33 mattm Exp $
