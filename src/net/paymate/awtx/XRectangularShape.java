...
/**
 * <p>Title: $Source: /cvs/src/net/paymate/awtx/XRectangularShape.java,v $</p>
 * <p>Description: </p>
 ...
 * @author	Jim Graham
 */
public abstract class XRectangularShape implements Cloneable {
  /**
   ...
   */
  public XRectangle2D getFrame() {
    return new XRectangle2D.Double(getX(), getY(), getWidth(), getHeight());
  }
   ...
   * @see #getFrame
   */
  public void setFrame(XPoint2D loc, XDimension2D size) {
   ...
   * @see #getFrame
   */
  public void setFrame(XRectangle2D r) {
   ...
   */
  public void setFrameFromDiagonal(XPoint2D p1, XPoint2D p2) {
   ...
   */
  public void setFrameFromCenter(XPoint2D center, XPoint2D corner) {
...
//   * 		<code>false</code> otherwise.
//   */
//  public boolean intersects(XRectangle2D r) {
...
//   *		       <code>false</code> otherwise.
//   */
//  public boolean contains(XRectangle2D r) {
...
//  }
  ...
  public XRectangle getBounds() {
    ...
    return new XRectangle( (int) x1, (int) y1,
                          (int) (x2 - x1), (int) (y2 - y1));
  }
