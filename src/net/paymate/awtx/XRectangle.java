...
/**
 * <p>Title: $Source: /cvs/src/net/paymate/awtx/XRectangle.java,v $</p>
 * <p>Description: </p>
...
public class XRectangle
   ...
   * @param height the height of the <code>Rectangle</code>
   */
  public XRectangle(int width, int height) {
   ...
   */
  public XRectangle(XPoint p, XDimension d) {
   ...
   */
  public XRectangle(XDimension d) {
   ...
   * @see       net.paymate.awtx.Component#getBounds
   * @see       #setBounds(Rectangle)
   * @see       #setBounds(int, int, int, int)
   * @since     JDK1.1
   */
  public XRectangle getBounds() {
    return new XRectangle(x, y, width, height);
  }
   ...
   * @see       #getBounds
   * @see	  net.paymate.awtx.Component#setBounds(net.paymate.awtx.Rectangle)
   * @since     JDK1.1
   */
  public void setBounds(XRectangle r) {
   ...
   * @see       #getBounds
   * @see       net.paymate.awtx.Component#setBounds(int, int, int, int)
   * @since     JDK1.1
   */
   ...
   * @see       net.paymate.awtx.Component#getLocation
   ...
   * @see       net.paymate.awtx.Component#setLocation(net.paymate.awtx.Point)
   * @see       #getLocation
   * @since     JDK1.1
   */
   ...
   * @see       #getLocation
   * @see	  net.paymate.awtx.Component#setLocation(int, int)
   * @since     JDK1.1
   */
   ...
   *                 along the y axis
   * @see       net.paymate.awtx.Rectangle#setLocation(int, int)
   * @see       net.paymate.awtx.Rectangle#setLocation(net.paymate.awtx.Point)
   */
   ...
   *            this <code>Rectangle</code>.
   * @see       net.paymate.awtx.Component#getSize
   ...
   * @see       net.paymate.awtx.Component#setSize(net.paymate.awtx.Dimension)
   * @see       #getSize
   * @since     JDK1.1
   */
   ...
   * @param width the new width for this <code>Rectangle</code>
   * @param height the new height for this <code>Rectangle</code>
   * @see       net.paymate.awtx.Component#setSize(int, int)
   * @see       #getSize
   * @since     JDK1.1
   */
   ...
   * @since     JDK1.1
   */
  public boolean contains(XRectangle r) {
  ...
  public XRectangle intersection(XRectangle r) {
    ...
    return new XRectangle(tx1, ty1, (int) tx2, (int) ty2);
  }
  ...
  public XRectangle union(XRectangle r) {
    ...
    return new XRectangle(x1, y1, x2 - x1, y2 - y1);
  }
  ...
  if (r instanceof XRectangle) {
      return intersection((XRectangle) r);
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof XRectangle) {
      XRectangle r = (XRectangle) obj;
      return ( (x == r.x) &&
              (y == r.y) &&
              (width == r.width) &&
              (height == r.height));
